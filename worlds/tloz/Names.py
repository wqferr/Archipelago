...
class ItemNames:
    BOOMERANG = "Boomerang"
    BOW = "Bow"
    MAGICAL_BOOMERANG = "Magical Boomerang"
    RAFT = "Raft"
    STEPLADDER = "Stepladder"
    RECORDER = "Recorder"
    MAGICAL_ROD = "Magical Rod"
    RED_CANDLE = "Red Candle"
    BOOK_OF_MAGIC = "Book of Magic"
    MAGICAL_KEY = "Magical Key"
    RED_RING = "Red Ring"
    SILVER_ARROW = "Silver Arrow"
    SWORD = "Sword"
    WHITE_SWORD = "White Sword"
    MAGICAL_SWORD = "Magical Sword"
    HEART_CONTAINER = "Heart Container"
    LETTER = "Letter"
    MAGICAL_SHIELD = "Magical Shield"
    CANDLE = "Candle"
    ARROW = "Arrow"
    FOOD = "Food"
    WATER_OF_LIFE_BLUE = "Water of Life (Blue)"
    WATER_OF_LIFE_RED = "Water of Life (Red)"
    BLUE_RING = "Blue Ring"
    TRIFORCE_FRAGMENT = "Triforce Fragment"
    POWER_BRACELET = "Power Bracelet"
    SMALL_KEY = "Small Key"
    BOMB = "Bomb"
    RECOVERY_HEART = "Recovery Heart"
    FIVE_RUPEES = "Five Rupees"
    RUPEE = "Rupee"
    CLOCK = "Clock"
    FAIRY = "Fairy"